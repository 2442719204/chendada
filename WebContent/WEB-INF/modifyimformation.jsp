...
<script type="text/javascript">
		  ...
		  $(function(){
	           ...
	           var question = $('#question').val();
	            var $op = $('select option');
	            $($op).each(function(index,obj){
	                if($.trim(question)== $(this).val()){
...
<form action="${pageContext.request.contextPath}/md.do?type=modify " method="post">
...
女</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
		  ...
		  <input type="hidden" value="${ps.aquestion }" id="question"/>
		  <table width="100%" border="0" cellspacing="2" class="upline">
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="uanswer" type="text" class="textinput" value="${ps.answer }"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#999999">不能少于4个字符，不区分大小写</font></td>
            </tr>
            <tr>
              <td style="text-align:right">备用邮箱：</td>
              <td><input name="uemail" type="text" class="textinput" value="${ps.email }"/></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td style="text-align:right">&nbsp;</td>
